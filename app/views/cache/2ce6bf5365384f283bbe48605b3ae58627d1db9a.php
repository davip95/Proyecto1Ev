    ...
    <form enctype="multipart/form-data" method="POST">
        <div class="padrecolumnas">
            ...
            <div class="columnacampos">
                ...
                <br><a href="index.php?controller=usuarios&action=opVer&id=<?php echo e($usuario['idusuario']); ?>" class="btn btn-danger" role="button">Cancelar Cambios</a>
            </div>
        </div>
    </form>
</div>
...
<?php echo $__env->make('plantilla_op', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\david\Desktop\FP\2º DAW (Curso 22-23)\Desarrollo Web en Entorno Servidor\Proyecto1Ev\app\views/usuarioModificarOp.blade.php ENDPATH**/ ?>