    ...
    <form enctype="multipart/form-data" method="POST">
        <div class="padrecolumnas">
            <div class="columnacampos">
                ...
                <br>
                <?php echo $error->ErrorFormateado('campo'); ?>
            ...
            <div class="columnacampos">
                ...
                <br>
                <?php echo $error->ErrorFormateado('valor'); ?>
            ...
            <div class="columnacampos">
                ...
                <br>
                <?php echo $error->ErrorFormateado('oplogico'); ?>
...
<h4><?php echo $error->ErrorFormateado('criteriovalor'); ?></h4>
<h5><a href="index.php?controller=tareas&action=listar" class="btn btn-danger" role="button">Volver a listado</a></h5>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('plantilla_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\david\Desktop\FP\2º DAW (Curso 22-23)\Desarrollo Web en Entorno Servidor\Proyecto1Ev\app\views/tareasBuscar.blade.php ENDPATH**/ ?>